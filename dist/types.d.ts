...
import { MapOptions, LatLngBoundsExpression, PolylineOptions, TileLayerOptions, WMSOptions, Layer, ImageOverlayOptions, MarkerOptions, LatLngExpression, PopupOptions, TooltipOptions, VideoOverlayOptions, LayerOptions, CircleMarkerOptions, GeoJSONOptions, GridLayerOptions, LayersControlEventHandlerFn, LayerEventHandlerFn, LeafletEventHandlerFn, ResizeEventHandlerFn, DragEndEventHandlerFn, ErrorEventHandlerFn, LeafletKeyboardEventHandlerFn, LeafletMouseEventHandlerFn, LocationEventHandlerFn, PopupEventHandlerFn, TileErrorEventHandlerFn, TileEventHandlerFn, TooltipEventHandlerFn, ZoomAnimEventHandlerFn } from 'leaflet';
...
declare type Child<T> = React.ReactElement<Partial<{
    [K in keyof T]: T[K];
}>>;
/** One or more JSX children elements */
declare type IntrinsicElementChildren<T> = {
    children?: Child<T> | Child<T>[];
};
/** One JSX children elements */
declare type IntrinsicElementChild<T> = {
    children?: Child<T>;
};
/** Common types for all layer JSX elements */
declare type LayerElementCommon<T> = React.RefAttributes<T> & IntrinsicElementChild<IntrinsicLayerAdditions> & LeafletReactFiberEvents & {
    mutable?: boolean;
};
...
interface IntrinsicLayers extends JSX.Element {
    ...
    } & LayerElementCommon<L.ImageOverlay>;
    /** A leaflet rectangle layer */
    lfRectangle: {
        bounds: LatLngBoundsExpression;
        options?: PolylineOptions;
    } & LayerElementCommon<L.Rectangle>;
    /** A leaflet marker */
    lfMarker: {
        latlng: LatLngExpression;
        options?: MarkerOptions;
    } & LayerElementCommon<L.Marker>;
    /** A leaflet tile layer */
    lfTiles: {
        urlTemplate: string;
        options?: TileLayerOptions;
    } & LayerElementCommon<L.TileLayer>;
    /** A leaflet WMS layer */
    lfTilesWMS: {
        baseUrl: string;
        options: WMSOptions;
    } & LayerElementCommon<L.TileLayer.WMS>;
    /** A leaflet video layer */
    lfVideo: {
        video: string | string[] | HTMLVideoElement;
        bounds: LatLngBoundsExpression;
        options?: VideoOverlayOptions;
    } & LayerElementCommon<L.VideoOverlay>;
    /** A leaflet polyline layer */
    lfPolyline: {
        latlngs: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][];
        options?: PolylineOptions;
    } & LayerElementCommon<L.Polyline>;
    /** A leaflet polygon layer */
    lfPolygon: {
        latlngs: LatLngExpression[] | LatLngExpression[][] | LatLngExpression[][][];
        options?: PolylineOptions;
    } & LayerElementCommon<L.Polygon>;
    /** A leaflet circle layer */
    lfCircle: {
        latlng: LatLngExpression;
        options?: CircleMarkerOptions;
    } & LayerElementCommon<L.Circle>;
    /** A leaflet circle marker layer */
    lfCircleMarker: {
        latlng: LatLngExpression;
        options?: CircleMarkerOptions;
    } & LayerElementCommon<L.CircleMarker>;
    /** A leaflet svg layer */
    lfSVG: {
        svgImage: string | SVGElement;
        bounds: LatLngBoundsExpression;
        options?: ImageOverlayOptions;
    } & LayerElementCommon<L.SVGOverlay>;
...
interface IntrinsicGroups extends JSX.Element {
    ...
    lfLayerGroup: {
        ...
        mutable?: boolean;
    } & LeafletReactFiberEvents & IntrinsicElementChildren<IntrinsicLayerAdditions> & IntrinsicElementChildren<IntrinsicLayers>;
...
export declare type JSXRenderer = (element: JSX.Element, container: HTMLElement) => Element;
/** Leaflet customization types. Use them to help with augmenting the JSX namespace */
export declare namespace LeafletExtensions {
    /** Updatable class constructore wrapper type E.g.
     * ```ts
     * constructor(params: Updatable<MyClassParams>) { }
     * ```
     * */
    type Updatable<Params = {}> = Params & {
        jsxRenderer?: JSXRenderer;
    };
    type Control<Klass extends L.Control = any, Params = {}> = {
        klass: new (...args: any) => Klass;
        params: {
            position: L.ControlPosition;
            mutable?: boolean;
        } & Params & IntrinsicElementChild<any>;
    };
    type Layer<Klass extends L.Layer = any, Params = {}> = {
        klass: new (...args: any) => Klass;
        params?: Params;
    } & LayerElementCommon<Klass>;
    type Handler<Klass extends L.Handler = any> = {
        name: string;
        klass: new (...args: any) => Klass;
        enabled: boolean;
    };
...
export declare type IntrinsicMapChildren = IntrinsicElementChildren<IntrinsicLayers>;
...
export interface IntrinsicMap extends JSX.Element {
    ...
    } & IntrinsicMapChildren & IntrinsicElementChildren<IntrinsicLayerAdditions>;
}
